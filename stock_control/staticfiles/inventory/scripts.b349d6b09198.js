...
console.log("👀 Checking for #id_product_dropdown...");
const productDropdown = document.getElementById("id_product_dropdown");
console.log("📦 Found productDropdown:", productDropdown);
...
async function fetchProductDetailsById(productId) {
    try {
        ...
        // ✅ Fill all relevant fields (manual + common)
        document.getElementById("id_product_name").value = data.name || "";
...
if (productDropdown) {
    console.log("✅ Attaching event listener to productDropdown...");
    productDropdown.addEventListener("change", function () {
        const selectedId = this.value;
        if (selectedId) {
            console.log("🔄 Manual product selected:", selectedId);
            fetchProductDetailsById(selectedId);
        }
    });
} else {
    console.warn("❌ Dropdown not found. Manual entry won't work.");
}
