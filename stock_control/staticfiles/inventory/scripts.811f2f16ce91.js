document.addEventListener("DOMContentLoaded", function () {
    ...
    setupTableSearch("searchInputProd", "productTable", [0, 1, 7]); // Search by Product Name (0), Product Code (1), Supplier (7)

    // ✅ Enable search for Withdrawal Tracking Table
    setupTableSearch("searchInputTrack", "withdrawalTable", [1, 5, 6]); // Search by Product (1), Barcode (5), User (6)
