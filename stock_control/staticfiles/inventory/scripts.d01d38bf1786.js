document.addEventListener("DOMContentLoaded", function () {
    ...
    if (reportForm) {
        ...
        new Chart(document.getElementById("stockLevelsChart").getContext("2d"), {
            type: "bar",
            data: {
                labels: getChartData("stockLevelsChart").labels,
                datasets: [
                    { label: "Current Stock", data: getChartData("stockLevelsChart").stock, backgroundColor: "blue" },
                    { label: "Threshold", data: getChartData("stockLevelsChart").thresholds, backgroundColor: "red" }
                ]
            }
        });
        ...
        new Chart(document.getElementById("withdrawalsOverTimeChart").getContext("2d"), {
            type: "line",
            data: {
                labels: getChartData("withdrawalsOverTimeChart").dates,
                datasets: [{
                    label: "Total Withdrawals",
                    data: getChartData("withdrawalsOverTimeChart").withdrawals,
                    borderColor: "green",
                    fill: false
                }]
            }
        ...
        new Chart(document.getElementById("forecastChart").getContext("2d"), {
            type: "line",
            data: {
                labels: [...forecastData.dates, ...forecastData.forecastDates],
                datasets: [
                    { label: "7-Day SMA", data: forecastData.sma7, borderColor: "orange" },
                    { label: "14-Day SMA", data: forecastData.sma14, borderColor: "red" },
                    { label: "Forecast", data: [...Array(forecastData.withdrawals.length).fill(null), ...forecastData.forecastValues], borderColor: "purple", borderDash: [5, 5] }
                ]
            }
        });
    
        // ✅ Render Top Withdrawals Chart (Static Example)
        new Chart(document.getElementById("topWithdrawalsChart").getContext("2d"), {
            type: "bar",
            data: {
                labels: ["Product A", "Product B", "Product C", "Product D"],
                datasets: [{
                    label: "Top Withdrawals",
                    data: [50, 40, 30, 20],
                    backgroundColor: "purple"
                }]
            },
        ...
        // ✅ Render Stock Projection Chart (Static Example)
        ...
        function openModal(chartId) {
            ...
            modalChart = new Chart(ctx, chartElement.chart.config); // Clone existing chart config
