document.addEventListener("DOMContentLoaded", function () {
    ...
    const modelFields = {
        ...
        "stock": ["product_code", "name", "supplier", "threshold", "lead_time", "get_full_items_in_stock"],
        "purchase_orders": ["product_name", "quantity_ordered", "ordered_by", "order_date", "expected_delivery", "status"]
      };
    ...
    // ✅ Make sure form submits normally — DO NOT prevent default!
    if (reportForm) {
        reportForm.addEventListener("submit", () => {
            console.log("📥 Form is submitting normally to download the report...");
        });
    }
});
