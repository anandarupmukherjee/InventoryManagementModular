document.addEventListener("DOMContentLoaded", function () {
    ...
    // setupTableSearch("searchProduct", "productTable", [0, 1, 7]); // Search by Product Name (0), Product Code (1), Supplier (7)

    // // ✅ Enable search for Withdrawal Tracking Table
    // setupTableSearch("searchWithdrawal", "withdrawalTable", [1, 5, 6]); // Search by Product (1), Barcode (5), User (6)
...
document.addEventListener("DOMContentLoaded", function () {
    console.log("Scripts loaded successfully"); // Debugging check
    ...
    function setupTableSearch(searchInputId, tableId, columnIndexes) {
        ...
        if (!searchInput || !table) {
            console.error(`Error: Could not find ${searchInputId} or ${tableId}`);
            return;
        }
        ...
        console.log(`Search enabled for ${tableId}`);
    }
